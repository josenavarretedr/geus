<template>
  <div class="container">
    <div class="inputFile">
      <label >Sube evidencia fotográfica</label> <br />
      <!-- <v-file-input prepend-icon="mdi-camera" chips label="Seleciona el archivo" @change="uploadFile" :id="namePath"></v-file-input> -->
...
async function uploadFile(event) {
  ...
  try {
    ...
    const fileRef = refStorage(storage, `${props.idUser}/${props.namePath}/${file.name}`);
